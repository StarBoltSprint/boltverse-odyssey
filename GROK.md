...
1. Empty road plate only (Video A) — biome décor, no dog. Lane material first (law 35 menu A–D, or the material already in `{PAINT}`). GPU zones first (law 36): keyed layers over that plate; do not tile densify.
