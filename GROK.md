...
**HARD — make controllable Bolt on a Lane:** [`biome/docs/13-make-bolt-lane.md`](biome/docs/13-make-bolt-lane.md) — product brief / order of work. [`biome/docs/13b-anti-sticker-contact.md`](biome/docs/13b-anti-sticker-contact.md) — compositor anti-sticker + contact shadow. [`biome/docs/13c-green-despill.md`](biome/docs/13c-green-despill.md) — green key + despill factory. [`biome/docs/14-rotary-gallop.md`](biome/docs/14-rotary-gallop.md) — rotary gallop + ribbon turn.
