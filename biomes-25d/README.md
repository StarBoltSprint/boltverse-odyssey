...
Engine: [FILM-STACK.md](../FILM-STACK.md) (**3-take PRIMARY** + assets stack). Cook: [COOK-BIOME-25D.md](../COOK-BIOME-25D.md). PLAY clock: [THREE-TAKE-PLAY.md](../THREE-TAKE-PLAY.md) (3.50s swipe, three living players, never `kick()`).  
