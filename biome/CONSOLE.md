# CONSOLE — Grok chat vs Sprint Play

**Grok chat = the console.** Boot / teaser / talk.  
**Boltverse Odyssey = the game.** Tappable Sprint lives on the **Interactive Play** surface (native Grok Build game console, in-app).

Do **not** paste a Play URL in chat. Do **not** paste `*.grok.me` in the player reply. Chat mp4s are **not** hitboxes.
