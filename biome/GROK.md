...
**HARD — empty still defaults (any biome).** Start empty still / Video A from [docs/20-default-plate-proportions.md](docs/20-default-plate-proportions.md). Player may override. Frost aurora KEEP numbers = [20b](docs/20b-frost-aurora-proportions.md).
