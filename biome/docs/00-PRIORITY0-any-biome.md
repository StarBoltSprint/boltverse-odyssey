...
**START HERE** → a playable composite (any paint) pastes [`COLD_START-biome-method.md`](COLD_START-biome-method.md) first. Section A is the road densify. Section B is the forest / open-ground world cook (law 43). Densify / QC order for a road: [`../scripts/biome-cook/README.md`](../scripts/biome-cook/README.md) (steps 1→17) and [`COLD_START-biome-cook.md`](COLD_START-biome-cook.md). This file stays the parity law inside that method.
