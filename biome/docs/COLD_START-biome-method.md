...
3. When the rail applies, the law — do not delete it:
   ...
   - GPU particles (motes, paws, Howl sparks), after law 52: [`53-gpu-particles.md`](53-gpu-particles.md) · [`../scripts/jade-lod/particles.ts`](../scripts/jade-lod/particles.ts)
