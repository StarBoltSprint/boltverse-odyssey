...
Prismwake example: [`plans/prismwake-sprint.md`](plans/prismwake-sprint.md) · [`COLD_START-prismwake.md`](COLD_START-prismwake.md)

---

## Why

`m` snowballs refs ([22-m](22-m-densify-snowball.md) · [28](28-stills-two-rails.md)). Without a plan the next plate is a random lantern, then a t-shirt, then a wall. A plan makes the run a **short film**: the world wakes in a written order, danger stays cinematic, KEEP geometry never changes.
