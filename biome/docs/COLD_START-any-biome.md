...
2c. **`biome/docs/36-gpu-zones-lena-procedural.md`** ← **before** those stills and Video A. Densify stays one continuous plate (Rail A). GPU zones are keyed layers over it (Rail B). Do not chop one densify plate into spatial GPU tiles. Paste: `biome/docs/COLD_START-gpu-zones.md`.
