...
| [52-engine-vs-play.md](52-engine-vs-play.md) | Engine draws. Play is the paws. geoRing 1 (3×3 mesh) versus memRing 2 (5×5 prev and groundY). bandDraw stays apart from holdBand. Far ↔ cull shrinks the impostor quad only (180 ms, scale 1 ↔ 0.35). Path noise, Howl burst, `lock/bolt.glb` as the Pack KEEP. No second wolf. Stubs in [`../scripts/jade-lod/`](../scripts/jade-lod/README.md). |
