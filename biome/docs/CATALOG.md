...
| [53-gpu-particles.md](53-gpu-particles.md) | GPU particle overlay. One Points draw, 1400 slots. CPU writes births. Vertex shader moves them. Every point samples an Imagine cutout (moss dust, ember, spark dust). Howl shatter's primary picture is `crystal_burst_vN`. A missing sheet hides the FX. A flat colored disc is FAIL. Not the world. Stub [`../scripts/jade-lod/particles.ts`](../scripts/jade-lod/particles.ts). |
