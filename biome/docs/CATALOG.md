...
| [53-gpu-particles.md](53-gpu-particles.md) | GPU particle overlay. One Points draw, 1400 slots. CPU writes births. Vertex shader moves them. Motes, paw sparks, Howl burst. Not the world. Stub [`../scripts/jade-lod/particles.ts`](../scripts/jade-lod/particles.ts). |
