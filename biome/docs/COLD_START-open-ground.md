...
Volume (capsules and cards in meters) is [44-imagine-volume-stack.md](44-imagine-volume-stack.md). Card shading is [45-shader-graph-look-kitchen.md](45-shader-graph-look-kitchen.md). This file stays the sky and ground numbers.
