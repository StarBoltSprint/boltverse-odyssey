...
| Bolt cutout (green) | **REUSE** [`lock/bolt-gallop-cycle.mp4`](../../lock/bolt-gallop-cycle.mp4) | Key + despill + composite onto A. Then COMPOSITE GATE (13/13b/13c/13d/14c) before KEEP. No new Imagine dog sprint. |
...
**New biome Bolt = REUSE** [`lock/bolt-gallop-cycle.mp4`](../../lock/bolt-gallop-cycle.mp4). Key + despill ([13c](13c-green-despill.md)) → `computeScale` / `assertScale` ([13d](13d-auto-scale.md)) → **`gallop-clock` / `assertGallopClock`** ([14c](14c-gallop-clock.md)) → composite onto Video A → **COMPOSITE GATE** scale + gallop-clock + plate-grade + paw contact ([13](13-make-bolt-lane.md) / [13b](13b-anti-sticker-contact.md) / [13d](13d-auto-scale.md) / [14c](14c-gallop-clock.md)) **BEFORE** KEEP. Do **not** call `imagineBoltClip`.
