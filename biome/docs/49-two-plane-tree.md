...
| Impostor cross | `(0, (hBole + hCrown) * 0.35, 0)` × 2 | about `1.2 × 1.6`, second yaw `+ π/2` |
...
| Child | Yaw |
|---|---|
| Bole | 0.55 toward the camera |
| Crown | 0.85 toward the camera. Near may face the camera. |
...
| Far ↔ cull | 180 | both planes of the cross, scale 1.00 ↔ 0.35 with the alpha. Not the bole. Not the group. Yaw stays planted. | none |
...
- Far face-cam, including a 0.9 lean: FAIL. Both planes stay on the spawn yaw.
