...
Lena climb = **3-lane luminous path** under Bolt, not float. Law: `biome/docs/19-luminous-path-climb.md`. Paste: `biome/docs/COLD_START-luminous-path.md`. Incline / duration / space look: `biome/docs/21-paw-to-galaxy.md`. Paste: `biome/docs/COLD_START-paw-to-galaxy.md`.
