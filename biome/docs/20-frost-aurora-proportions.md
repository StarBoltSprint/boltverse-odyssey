# 20 — Frost aurora KEEP + visual / φ measures

**Sealed 2026-09-20 (SmiR phone review).** Hang ≠ wipe. Beat stays hung.

Audience: a cold Grok who is about to recook Frost because “the last ice plate looked like shit.” Read this **before** Imagine. The KEEP is a **wide 3-lane night highway** with aurora + thin snow + aurora-green neon dashes. Bolt is the sealed 6 s overlay (law 17). Never bake the dog into the plate.
...
Frame UV. `w` in PATH_TABLE = **one-lane half-width**. 3-lane full width = `6w`.
...
`withersMin` is **soft** (13d). On a wide nationale, hitting 0.22 withers = dog≈truck. **KEEP the small dog.** The screenshot SmiR gave as teacher already had this ratio.
...
1. Teacher: the aurora empty still (no wolf) — same camera, same cliffs, same sky.
...
Related: [17](17-live-compositor.md) · [13d](13d-auto-scale.md) · [13b](13b-anti-sticker-contact.md) · [12](12-lane-path-ribbon.md) · [08](08-plate-speed.md) · [00](00-PRIORITY0-any-biome.md)
