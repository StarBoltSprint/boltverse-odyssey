...
| 5 | Video A empty rush. `imagineBiomeClip`, **48 fps**, speed law. Frost: no `setpts` 2.7× warp. | [`biome/docs/08-plate-speed.md`](../../docs/08-plate-speed.md) · [`biome/docs/02-videos.md`](../../docs/02-videos.md) · [`20b`](../../docs/20b-frost-aurora-proportions.md) | [`biome/prompts/video-empty-plate.txt`](../../prompts/video-empty-plate.txt) |
