/** ARCHIVE FAIL — scissor + IGN `fract(dot)` grain. Do NOT copy into Live.
 * Hung 2026-09-20 as prev of law 17 Live compositor (`bolt-key-gl.ts`).
 * Copying this = vertical bars + eaten hind paws + sticker.
 */
/**
