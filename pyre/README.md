...
La méthode pour tout refaire Pyre est dans [METHOD.md](METHOD.md). Cette méthode est la base any-biome : [`biome/docs/COLD_START-biome-method.md`](../biome/docs/COLD_START-biome-method.md). La section A est la route. La section B est la forêt (sol ouvert) : noir, quatre ciels, une tuile, l'horizon, puis le GPU. Les chiffres restent [GROVE.md](GROVE.md) et la loi 43. Le volume (capsule + cartes) est la loi 44 : [`biome/docs/44-imagine-volume-stack.md`](../biome/docs/44-imagine-volume-stack.md). Pyre reste l'exemple Diablo, pas le seul type de biome.
