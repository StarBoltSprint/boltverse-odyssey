...
- **at-A / at-B KEEP seals** — [`lock/SEAL-at-a.jpg`](lock/SEAL-at-a.jpg) / [`lock/SEAL-at-b.jpg`](lock/SEAL-at-b.jpg). Imagine Agent ice-cathedral KEEP (drops [`hall-stills/seal/at-a-ice.jpg`](hall-stills/seal/at-a-ice.jpg) + [`at-b-ice.jpg`](hall-stills/seal/at-b-ice.jpg)). Frozen pose+décor until SmiR reseals. Agent remains primary for future styles. `cook-room` **SKIPS** `imagineStill` when these exist. Smoke still gates. Soft KEEP banned.
