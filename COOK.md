...
|---|---|---|---|---|---|
| breath-spawn | image_to_video on spawn | spawn | spawn | 6s | loop, feet glued, hall frozen |
| breath-A | image_to_video on atA | atA | atA | 10s | loop, feet glued |
| breath-B | image_to_video on atB | atB | atB | 10s | loop, feet glued |
