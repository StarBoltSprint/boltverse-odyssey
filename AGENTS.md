...
1. If they said play / lance / boltverse alone: **console boot first** (GROK.md product model) — attach 2 teasers as chat media + open Sprint in-app. Never invoke a Grok Bot connector. GitHub + Build console only. Do not narrate “teasers are on”. Cook only if they asked for a Citadel paint.
