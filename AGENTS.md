...
6. [`biome/docs/10-bolt-cutout-law.md`](biome/docs/10-bolt-cutout-law.md) — HARD Bolt cutout (REUSE lock/bolt-gallop-cycle.mp4 **CANON 6s/534/96fps** → key + composite; then COMPOSITE GATE 13/13b/13c/13d/14c/15/16 scale+gallop-clock+GPU+light+contact+FX before KEEP)
7. [`biome/docs/00-PRIORITY0-any-biome.md`](biome/docs/00-PRIORITY0-any-biome.md) — Frost-parity for **any** biome. Kitchen paste: [`biome/docs/COLD_START-any-biome.md`](biome/docs/COLD_START-any-biome.md). FX table: [`biome/docs/16-biome-ground-fx.md`](biome/docs/16-biome-ground-fx.md).
...
**HARD — GPU compositor:** [`biome/docs/15-gpu-compositor.md`](biome/docs/15-gpu-compositor.md) — WebGL one-pass; play loop 1×; no per-frame seek; no 534-canvas harvest. FX table (16) is drawn in this GPU family. Any-biome law: [`biome/docs/00-PRIORITY0-any-biome.md`](biome/docs/00-PRIORITY0-any-biome.md) · FX: [`biome/docs/16-biome-ground-fx.md`](biome/docs/16-biome-ground-fx.md). Cook paste: [`biome/docs/COLD_START-any-biome.md`](biome/docs/COLD_START-any-biome.md) (supersedes [`COLD_START-gpu-6s.md`](biome/docs/COLD_START-gpu-6s.md) for any biome).
