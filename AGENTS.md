...
6. [`biome/docs/10-bolt-cutout-law.md`](biome/docs/10-bolt-cutout-law.md) — HARD Bolt cutout (REUSE lock/bolt-gallop-cycle.mp4 **CANON 6s/534/96fps** → key + composite; then COMPOSITE GATE 13/13b/13c/13d/14c/15 scale+gallop-clock+GPU+light+contact before KEEP)
...
**HARD — GPU compositor:** [`biome/docs/15-gpu-compositor.md`](biome/docs/15-gpu-compositor.md) — WebGL one-pass; play loop 1×; no per-frame seek; no 534-canvas harvest. Cold-start paste: [`biome/docs/COLD_START-gpu-6s.md`](biome/docs/COLD_START-gpu-6s.md).
