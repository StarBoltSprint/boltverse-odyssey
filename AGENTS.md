...
**Kitchen — do not read aloud:** Pack Play (kitchen only) = https://boltverse-odysseyyy.grok.me (supersedes https://heart-giant-plum-lotus.grok.me). Citadel preview mp4 = [`stock/citadel/preview-loop.mp4`](stock/citadel/preview-loop.mp4) (poster `stock/citadel/preview-first.jpg`) — **sole** cold-start Welcome teaser. Biome preview mp4 = [`stock/biome/preview-loop.mp4`](stock/biome/preview-loop.mp4) + `preview-first.jpg` — optional archive, **not attached at boot**. Play videos **loop forever** (`muted playsInline autoPlay loop` + watchdog re-play on pause/ended). Loop the Citadel stock in Play; in chat as preview.
