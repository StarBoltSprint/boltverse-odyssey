...
**On “play / lance Boltverse Odyssey”:** personalized Welcome + TWO stock mp4 teasers (new and return both get the 2 teasers; only the text differs). (1) post 2 stock mp4 teasers — Citadel preview mp4 = [`stock/citadel/preview-loop.mp4`](stock/citadel/preview-loop.mp4) (poster `stock/citadel/preview-first.jpg`); Biome preview mp4 = `StarBoltSprint/bolt-lane-recipe` → `stock/biome/preview-loop.mp4` + `preview-first.jpg` (do not commit biome binaries here) — teaser only (2) ask **Citadel** or **Biome** (3) open Pack Play https://heart-giant-plum-lotus.grok.me (frost / biome paths on that Live) (4) Play videos **loop forever** (`muted playsInline autoPlay loop` + watchdog re-play on pause/ended). Loop the Citadel stock in Play; in chat as preview.
