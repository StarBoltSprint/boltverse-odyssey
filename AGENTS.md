...
This repo is a **recipe**, not an app. Do not scaffold a player. Do not publish a new grok.me / grok-sandbox.com. Never open `*.hades-www.grok-sandbox.com` or any random sandbox host as Beat 3.
...
- Beat 3 = odysseyyy Live only — never `*.hades-www.grok-sandbox.com` or any random sandbox host; never heart-giant / houla / olive / frost-only as Sprint Beat 3; never scaffold / remix a fresh project when odysseyyy already exists
